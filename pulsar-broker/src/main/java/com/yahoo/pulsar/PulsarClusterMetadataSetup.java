...
public class PulsarClusterMetadataSetup {
    ...
    public static void main(String[] args) throws Exception {
        ...
        arguments.dataZookeeper = isBlank(arguments.dataZookeeper) ? arguments.localZookeeper : arguments.dataZookeeper;
        log.info("Setting up cluster {} with zk={} dzk={} global-zk={}", arguments.cluster, arguments.localZookeeper,
        ...
        ZooKeeper localZk = zkfactory.create(arguments.localZookeeper, SessionType.ReadWrite, 30000).get();
        // use localZk for dataZookeeper if dataZk is not provided or it is same as localZk
        ZooKeeper dataZk = arguments.localZookeeper.equals(arguments.dataZookeeper) ? localZk
